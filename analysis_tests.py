...
STREAMING_TWEET_LONG = literal_eval(
    ...
    '": True, "favourites_count": 46, "screen_name": "elonmusk", "notif'
    ...
    ' "media": [{"expanded_url": "https://twitter.com/elonmusk/status/8'
...
STREAMING_TWEET_SHORT = literal_eval(
    ...
    'urites_count": 46, "screen_name": "elonmusk", "notifications": Non'
